...
winsha256=`shasum -a 256 dist/Blacknet-${version}1.exe`
...
curl --request POST --header "Private-Token: ${gitlab_private_token}" --form "file=@dist/Blacknet-${version}1.exe" "https://gitlab.COM/api/v4/projects/blacknet-ninja%2Fblacknet-desktop/uploads"
